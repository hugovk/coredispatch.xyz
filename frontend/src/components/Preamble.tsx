export function Preamble() {
  return (
    <p className="mb-8 text-xs text-muted">
      ...
      {" \u00b7 "}
      <a href="https://github.com/savannahostrowski/coredispatch/issues/new?template=submit-link.yml" className="text-accent hover:text-accent-hover">Submit a link</a>
      {" \u00b7 "}
